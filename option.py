...
# Data specifications
# parser.add_argument('--dir_data', type=str, default='/home/featurize/data',
...
parser.add_argument('--data_range', type=str, default='1-800/810-810',
...
# Log specifications
parser.add_argument('--save', type=str, default='./results/ipt/',
